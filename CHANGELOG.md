...
- Full-screen photos now render only the high-resolution image layer; the persistent 1280-pixel underlay and its extra compositing pass have been removed.
